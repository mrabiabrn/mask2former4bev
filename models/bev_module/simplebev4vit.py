...
class SimpleBEV4ViT(nn.Module):
    ...
    def forward(self, features_dict, data_dict):
        ...
        # features B, NCAMS, P, featdim
        h = int(448 / 16)
        w = int(800 / 16)
        features = features.view(-1, h, w, 192)                     # B*NCAMS, h, w, feat_dim
        features = features.permute(0, 3, 1, 2)                     # B*NCAMS, feat_dim, h, w
        ...
        return bev_feats, out_dict #, None
